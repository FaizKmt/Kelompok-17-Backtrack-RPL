...
function tambahProduk($post)
{
    ...
    $daya       = htmlspecialchars($post['daya']);
    ...
    mysqli_query($konek, "INSERT INTO produk VALUES(
        '', '$nama', '$harga', '$gambar' ,'$kategori', '$deskripsi','$create','$nohp','$daya'
    )");
...
function ubahProduk($id, $post)
{
    ...
    $sql = mysqli_query($konek, "UPDATE produk SET nama='$nama', harga='$harga', gambar='$gambar', kategori='$kategori', deskripsi='$deskripsi',createat='$create', updateat='$update',nohp='$nohp',daya='$daya' WHERE id_produk = '$id' ");
    if ($sql > 0) {
