...
<div class="row mt-5">
    <div class="col py-3">
        <h4 class="text-uppercase">Cari Derek Yang Sesuai untuk anda</h4>
    </div>
</div>
<!-- Produk Baru -->
        ...
        <div class="col-sm-3 my-2 card shadow-sm bg-white">
            ...
            <div class="d-flex justify-content-around p-2 w-75 m-auto">
                ...
                <form method="POST" action="">
                    ...
                    <button  class="btn btn-sm btn-warning" ><a href="whatsapp/whatsapp.php?id=<?=$value->nohp ?>"> Pesan </a></button>
                </form>
            </div>
        </div>
    <?php endforeach; ?>
